                        ...
                        songsArray.map((song, index) => <Fragment key={index}>
                            <div className="view-box" key={index}>
                                ...
                                <div className="head-view-buttons">
                                    ...
                                    <div className="head-view-avatar">{readyAuthors[index] && readyAuthors[index]  ? <img src={require(`../../uploads/authors/image/${readyAuthors[index]}`)} height="32px" /> : <img src={require("../style/guitar.png")} height="32px" />}</div>
                                ...
                                <div className="content-view" style={contentStyle} onClick={e=> handleContent('auto')}>
                                    {
                                        song.image && <Fragment>
                                            <div className="song-image-view">
                                                <img src={require(`../../uploads/authors/image/${song.image}`)} />
                                            </div>
                                        </Fragment>
                                    }
                                    {
                                        song.text && <Fragment>
                                            ...
                                            <div className="view-user">{song.avatar.charAt(0) == "/" ? <img src={song.avatar} height="24px" /> : <img src={require(`../../uploads/avatar/${song.avatar}`)} height="15.5px" />} {song.name}, <Moment format="YYYY-MM-DD">{song.date}</Moment> </div>
                                            </div>
