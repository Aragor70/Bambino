                                    ...
                                    <div className="liked-song">
                                    {
                                        songsArray.map((song, index) => <Fragment key={index}>
                                            ...
                                            <div className="boxed-song" key={index}>
                                                <div className="liked-avatar">{readyAuthors[index] && readyAuthors[index]  ? <img src={`https://s3.eu-west-2.amazonaws.com/onloud-storage/author/image/${readyAuthors[index]}`} height="32px" /> : <img src={require("../style/guitar.png")} height="32px" />}</div>
